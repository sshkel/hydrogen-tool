...
describe("Working Data calculations", () => {
    ...
    it("calculates opex for ammonia solar", async () => {
        ...
        const expected: { [key: string]: number[] } = {
            ...
            "Water Costs": [
                255782.6, 262177.16, 268731.59, 275449.88, 282336.13, 289394.53,
                296629.4, 304045.13, 311646.26, 319437.42, 327423.35, 335608.94,
                343999.16, 352599.14, 361414.12, 370449.47, 379710.71, 389203.47,
                398933.56, 408906.9,
            ],
    ...
    it("calculates opex for ammonia hybrid with battery and degradation", async () => {
        ...
        const expected: { [key: string]: number[] } = {
            ...
            "Power Plant OPEX": [
                10029625, 10280365.63, 10537374.77, 10800809.13, 11070829.36,
                11347600.1, 11631290.1, 11922072.35, 12220124.16, 12525627.26,
                12838767.95, 13159737.15, 13488730.57, 13825948.84, 14171597.56,
                14525887.5, 14889034.69, 15261260.55, 15642792.07, 16033861.87,
            ],
    ...
    it("calculates opex for methanol hybrid with battery", async () => {
        ...
        const expected: { [key: string]: number[] } = {
            ...
            "Power Plant OPEX": [
                ...
                47_120_662.97, 48_298_679.54, 49_506_146.53, 50_743_800.19,
                52_012_395.2, 53_312_705.08, 54_645_522.71, 56_011_660.77,
                57_411_952.29, 58_847_251.1, 60_318_432.38, 61_826_393.19,
                63_372_053.02, 64_956_354.34, 66_580_263.2, 68_244_769.78,
                69_950_889.03, 71_699_661.25, 73_492_152.78, 75_329_456.6,
            ],
