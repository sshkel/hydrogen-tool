...
describe("Working Data calculations", () => {
  ...
  describe("Cash Flow Analysis", () => {
    ...
    it("calculates cash flow analysis for hybrid with battery, grid and surplus retail", (done) => {
      ...
      // Values with grid connection const in the OPEX
      ...
      // TODO: For some reason, grid connection cost is not included in cash flow analysis total OPEX
      const cashFlowAnalysis = [
        -23814000, -20859759.927105345, -17836766.852388322,
        -14743301.950803377, -11577603.426678807, -8337865.439451124,
        -5022237.002542748, -1628820.8547116634, 1844327.6968151978,
        1635667.6246174402, -4876224.906831335, 91842.24323165044,
        5171353.57204621, 10365095.184081133, 15675922.83641693,
        21106763.68006112, 26660618.044796415, 27959349.60559336,
        33768533.91004338, 39710190.32210465, 45787630.64446744,
        45787630.64446744,
      ];
